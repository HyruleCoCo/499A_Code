...
// Inertial             inertial      5               
// fly                  motor         21              
// enter                motor_group   18, 11          
// lpusher              digital_out   G               
// rpusher              digital_out   H               
// hang                 digital_out   A               
// ML                   motor         17              
// MR                   motor         13              
...
void usercontrol(void) {
  ...
  while (1) {
    ...
    rpush();
    climb();
    /*if(Controller1.ButtonLeft.pressing() && Controller1.ButtonRight.pressing() && Controller1.ButtonDown.pressing() && Controller1.ButtonUp.pressing()){
      //driveskills();
      skills();
    }*/
...
int main() {
  ...
  pre_auton();
  while(auto_started){    
  //prints animation on brain screen
  vex::Gif gif("cosmoblink.gif", 185, 50 ); 
